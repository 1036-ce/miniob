...
{
  vector<unique_ptr<LogicalOperator>> &children_opers = update_oper.children();
  ASSERT(children_opers.size() == 1, "update logical operator's sub oper number should be 1");
