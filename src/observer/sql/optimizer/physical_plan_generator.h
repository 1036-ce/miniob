...
private:
  ...
  RC create_plan(ViewGetLogicalOperator &logical_oper, unique_ptr<PhysicalOperator> &oper, Session *session);
  ...
  RC create_plan(MockLogicalOperator &logical_oper, unique_ptr<PhysicalOperator> &oper, Session *session);
